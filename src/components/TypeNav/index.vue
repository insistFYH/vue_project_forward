<template>
    ...
    <div class="type-nav">
        <div class="container">
            <div @mouseleave="leaveIndexSort">
                <h2 class="all" @mouseenter="showSort">全部商品分类</h2>
                <transition name="sort" appear>
                    <div class="sort" v-show="isShow">
                        <div class="all-sort-list2" @click="goSearch($event)">
                            <div class="item bo" v-for="(c1,index) in category" :key="c1.categoryId" :class="{cur:currentIndex==index}">
    ...
    .container {
        ...
        .sort {
            ...
            .all-sort-list2 {
                ...
                .cur {
                    background-color: rgb(243, 70, 61);
                }
            }
        }
        .sort-enter-active {
