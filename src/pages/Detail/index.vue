                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key=" spuSaleAttr.id">
                                ...
                                <dd changepirce="0" :class="{active:spuSaleAttrValue.isChecked==1}" v-for="(spuSaleAttrValue) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" @click="changeSelectAttrValue(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)">{{spuSaleAttrValue.saleAttrValueName}}</dd>
                            </dl>
                        </div>
                        <div class="cartWrap">
                            <div class="controls">
                                ...
                                <a href="javascript:" class="mins" @click="skuNumMins">-</a>
                            </div>
                            <div class="add">
...
export default {
    ...
    methods: {
        changeSelectAttrValue(spuSaleAttrValue, spuSaleAttrValueList) {
