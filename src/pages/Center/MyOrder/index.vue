<template>
    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="(record) in orderList.records" :key="record.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                                <span class="ordertitle">{{record.createTime}}　订单编号：{{record.outTradeNo}} <span class="pull-right delete"><img src="../images/delete.png"></span></span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="(orderDetail,index) in record.orderDetailList" :key="index">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="orderDetail.imgUrl" style="width:90px;height:80px">
            ...
            <Pagination :pageNo="page" :pageSize="limit" :total="orderList.total" :continues="5" @pageNoHandle="pageNoHandle" />
        </div>
        <!--猜你喜欢-->
        <div class="like">
            <h4 class="kt">猜你喜欢</h4>
