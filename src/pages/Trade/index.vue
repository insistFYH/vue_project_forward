<template>
    <div class="trade-container">
        ...
        <div class="content">
            ...
            <div class="address clearFix" v-for="(userAddress) in userAddressList" :key="userAddress.id" @click="selectUserAddress(userAddress,userAddressList)">
            ...
            <div class="detail">
                <h5>商品清单</h5>
                <ul class="list clearFix" v-for="(orderDetail) in orderDetailList" :key="orderDetail.skuId">
                    <li>
                        <img :src="orderDetail.imgUrl" alt="" style="width:80px;height:70px">
                    </li>
                    <li>
                        <p>
                            {{orderDetail.skuName}}</p>
                        <h4>7天无理由退货</h4>
                    </li>
                    <li>
                        <h3>{{orderDetail.orderPrice}}</h3>
                    </li>
                    <li>X{{orderDetail.skuNum}}</li>
                    <li>有货</li>
                </ul>
            </div>
            <div class="bbs">
        ...
        <div class="sub clearFix" @click="submitOrder">
            <a href="javascript:;" class="subBtn">提交订单</a>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        this.$store.dispatch("getOrderDetailList");
    },
    computed: {
        ...mapState({
            ...
            orderDetailList: (state) => {
                return state.trade.orderDetailVoList.orderDetailList || [];
            },
            orderInfo: (state) => {
    ...
    methods: {
        //选中用户地址信息
        selectUserAddress(userAddress, userAddressList) {
        ...
        async submitOrder() {
            ...
            let data = {
                consignee: this.userAddressList.consignee,
                consigneeTel: this.userAddressList.phoneNum,
                deliveryAddress: this.userAddressList.fullAdress,
                paymentWay: "ONLINE",
