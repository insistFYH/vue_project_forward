    ...
    <div>
        ...
        <div class="main">
            <div class="py-container">
                ...
                <!--selector-->
                <SearchSelector @trademarkHandle="trademarkHandle" @attrHandle="attrHandle" />
                ...
                <div class="details clearfix">
                        ...
                        <div class="navbar-inner filter">
                            <ul class="sui-nav">
                                <li :class="{active:isOne}" @click="changeSort(1)">
                                    <a>综合<span class="iconfont" :class="{'icon-long-arrow-up':isAsc,'icon-long-arrow-down':isDesc}" v-show="isOne"></span></a>
                                </li>
                                <li :class="{active:isTwo}" @click="changeSort(2)">
                                    <a>价格 <span class="iconfont" :class="{'icon-long-arrow-up':isAsc,'icon-long-arrow-down':isDesc}" v-show="isTwo"></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @pageNoHandle="pageNoHandle" />
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        attrHandle(attr, attrValue) {
            let item = `${attr.attrId}:${attrValue}:${attr.attrName}`;
        ...
        changeSort(flag) {
            let originOrders = this.searchParams.order;
            let originType = originOrders.split(":")[0];
            let originSort = originOrders.split(":")[1];
            //些许复杂
            // if (flag == originType) {
            //     if (originSort == "desc") {
            //         this.searchParams.order = `${originType}:${"asc"}`;
            //     } else {
            //         this.searchParams.order = `${originType}:${"desc"}`;
            //     }
            // } else {
